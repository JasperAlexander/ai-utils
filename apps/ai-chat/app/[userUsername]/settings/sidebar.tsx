...
import { HideSidebarButton } from '../[projectTitle]/hideSidebarButton'
import { Resizer } from '../[projectTitle]/resizer'
import { SidebarLink } from './sidebarLink'

export async function Sidebar({ username }: { username: string }) {
  return (
        ...
        <div className={styles.sidebarContent}>
          <div className={styles.sidebarHeader}>
            <div className={styles.sidebarHeaderTop}>
              ...
              <Link href={`/${username}`} className={styles.sidebarHeaderTitle}>
                {username}
              </Link>
            </div>
          </div>
          <div className={styles.sidebarMain}>
            <SidebarLink href={`/${username}/settings/profile`}>
              <svg viewBox='0 0 16 16' className={styles.sidebarLinkSvg}>
                <path d='M10.561 8.073a6.005 6.005 0 0 1 3.432 5.142.75.75 0 1 1-1.498.07 4.5 4.5 0 0 0-8.99 0 .75.75 0 0 1-1.498-.07 6.004 6.004 0 0 1 3.431-5.142 3.999 3.999 0 1 1 5.123 0ZM10.5 5a2.5 2.5 0 1 0-5 0 2.5 2.5 0 0 0 5 0Z'></path>
              </svg>
              <span className={styles.sidebarLinkSpan}>Profile</span>
            </SidebarLink>
            <SidebarLink href={`/${username}/settings/account`}>
              <svg viewBox='0 0 16 16' className={styles.sidebarLinkSvg}>
              ...
              <span className={styles.sidebarLinkSpan}>Account</span>
            </SidebarLink>
          </div>
        </div>
      </div>
